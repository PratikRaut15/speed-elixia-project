...
VALUES (
'476', '2017-03-07 20:14:04', 'Shrikant Suryawanshi', 'Change in get_vehiclewarehouse_details_vts for PerkinElmer Dashboard API', '0'
);
...
UPDATE  dbpatches
SET     patchdate = '2017-03-07 20:14:04'
        ,isapplied =1
WHERE   patchid = 476;
