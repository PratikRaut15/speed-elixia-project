...
<form action="reports.php?id=13" method="POST" onsubmit="getTempReport();
      ...
      $today = date('d-m-Y');
      $test = 2;
      include 'panels/humidityrep.php';
    ...
    <tr>
        ...
        <td>
            ...
            <a href='javascript:void(0)' onclick="get_pdfreportHumidity(<?php echo $_SESSION['customerno']; ?>, <?php echo $_SESSION['switch_to']; ?>);"><img src="../../images/pdf_icon.png" alt="Export to PDF" class='exportIcons' title="Export to PDF" /></a>

            <a href='javascript:void(0)' onclick="html2xlsHumidity(<?php echo $_SESSION['customerno']; ?>,<?php echo $_SESSION['switch_to']; ?>);
