...
VALUES (
'629', '2018-10-25 18:30:00', 'Manasvi Thakur','To Update get_LR_Details SP', '0');
...
BEGIN
    ...
    IF(customerNoParam IS NOT NULL )THEN
       ...
       SELECT DISTINCT(od.created_on) INTO varChitthiCreation
        ...
        AND td.is_tripend = is_tripendParam
        AND td.isdeleted =0
        AND od.isdeleted =0;
...
UPDATE  dbpatches
SET     patchdate = '2018-10-25 18:30:00'
        ,isapplied =1
WHERE   patchid = 629;