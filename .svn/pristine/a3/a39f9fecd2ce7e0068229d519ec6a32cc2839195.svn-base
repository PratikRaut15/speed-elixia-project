...
$aditiGpsUsers = array(
    ...
    $url = "http://speed.elixiatech.com/modules/api/gpsprovider/aditiGps/consumeApi.php";
	// $url = "http://localhost/speed/modules/api/gpsprovider/aditiGps/consumeApi.php";

	$objJsonReq = new stdClass();
	$objVendorDetails = new stdClass();
	$objVendorDetails->userName = $aditiGpsUsers[0]['userName'];
	$objVendorDetails->pwd = $aditiGpsUsers[0]['pwd'];
