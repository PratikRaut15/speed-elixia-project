...
<style>
  #vendoreff_filter{display: none}
  .dataTables_length{display: none}
</style>
<br/>
<div class='entry' >
  <center>
    <h3>Vendor Wise Placement Efficiency </h3>
    ...
    <table class='display table table-bordered table-striped table-condensed' id="vendoreff" style="width: 80%;" >
      <thead>
        <tr>
...
<script type='text/javascript'>
 var data = <?php echo json_encode($transporterEffArray); ?>;
 var tableId = 'vendoreff';
 var tableCols = [
