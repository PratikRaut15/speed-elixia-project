...
<script>
  ...
  function validate_upload() {
    var fileName = jQuery('#tyreFile').val();
    ...
    var size = jQuery("#tyreFile")[0].files[0].size;
    var valid_size = <?php echo $valid_size; ?>//2 mb
    if (size > valid_size) {
      show_error("File Size cannot cannot exceed 2 MB");
      return false;
    }
    if (fileName != 'Tyre.xlsx') {
      show_error("Please upload file Tyre.xlsx");
      return false;
    }
    ...
    <div class="col-sm-12">
      <center>
        ...
        if (isset($_POST['uploadFile'])) {
          ...
          $file_status = file_upload_validation($valid_file, $valid_size, 'tyreFile');
          if ($file_status != null) {
            echo $file_status;
          } else {
            include_once '../../lib/comman_function/PHPExcel.php';
            $excel_data = get_excel_data($_FILES['tyreFile']['tmp_name'], $max_columns, $max_row, $column_names);
            if (empty($excel_data)) {
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><input type="file" required="" id="tyreFile" name="tyreFile"></td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="100%"><span class="add-on"> Please Download The Sample Excel Sheet For Upload Serial Nos. <span class="mandatory">*</span>  <a href='pages/upload_files/Tyre.xlsx' target="_blank">  Download Excel Sheet</a></span></td>
