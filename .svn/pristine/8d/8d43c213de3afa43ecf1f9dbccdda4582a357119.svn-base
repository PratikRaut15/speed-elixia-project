...
class api {
    ...
    function check_userkey($userkey) {
        ...
        if (is_numeric($userkey)) {
            $sql = "SELECT u.userid,c.use_fuel_sensor, u.customerno, u.realname,u.fuel_alert_percentage, u.userkey, u.roleid, u.role, u.heirarchy_id, c.multiauth, c.customercompany
                    FROM user u
