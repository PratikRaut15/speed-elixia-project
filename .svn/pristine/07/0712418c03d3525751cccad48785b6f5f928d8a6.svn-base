...
<script>
     var initStartLat = <?php if($lat){echo $lat;}else{ echo $startpoint['lat'];} ?>;
     var initStartLong = <?php if($longi){echo $longi;}else{echo $startpoint['long'];} ?>;
</script>
