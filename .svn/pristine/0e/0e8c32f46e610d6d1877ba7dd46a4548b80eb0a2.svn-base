         ...
         <div class="navbar-inner">
             <div style="width: auto;" class="container">
                 ...
                 <ul role="navigation" class="nav">
                     ...
                     if ($_SESSION["use_pickup"]) {
                      ...
                      <li class="dropdown">
                          ...
                          <ul aria-labelledby="drop2" role="menu" class="dropdown-menu">
                              ...
                              echo "<li role='presentation'><a href='" . $_SESSION['subdir'] . "/modules/".$foldername."/pickup.php?id=2' tabindex='-1' role='menuitem'>Pickup Boy</a></li>";
                              ...
                              current_page_new($foldername.'/pick.php?id=3', 'All Orders', 'Orders');
                     ...
                     // current_page_new($foldername.'/pick.php?id=5', 'Run Route Algo', 'Order Mapping');  // change ganesh 16dec15
                      //current_page_new($foldername.'/pick.php?id=2', 'View Vehicle Directions', 'Direction Map'); // change ganesh 16dec15
