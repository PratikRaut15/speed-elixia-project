...
================================= */
 ...
 $(document).ready(function() {
		...
		$('.blinder').removeClass('active');
		$('#knob-message .'+$(this).data('element')).addClass('active');
...
$(document).keypress(function (e) {
  if (e.which == 13) {
	if(jQuery("#login").hasClass('active')==true){
	checkUserAuth();
	}else if(jQuery("#forgot").hasClass('active')==true){
	genNewPass();
	}
