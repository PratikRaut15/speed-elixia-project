...
if(!empty($reports)){
    ...
    $summary_data = generate_veh_dist_td_data($reports, $SDate, $EDdate);
}
else{
...
<table class="table newTable">
    ...
    <tbody>
        <tr><td colspan="10" style="text-align:center;"><?php echo "Highest distance travelled: $highest_dist, Vehicle No.: <b>$highest_dist_vehno</b>"; ?></td></tr>
        <tr><td colspan="10" style="text-align:center;"><?php echo "Total distance travelled on weekends: <b>$total_wkend_dist Kms</b>"; ?></td></tr>
    </tbody>
</table>
</div>