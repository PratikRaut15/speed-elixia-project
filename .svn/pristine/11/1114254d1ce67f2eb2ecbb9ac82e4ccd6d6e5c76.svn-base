...
function getVehicleForVehicleDashboard($vehicleId) {
    $vehiclemanager = new VehicleManager($_SESSION['customerno']);
    //$vehicledata = $vehiclemanager->getvehiclesforrtdwithpagination();
    $vehicledata['vehicleData'] = $vehiclemanager->getVehicleForVehicleDashboard($vehicleId);
...
function display_vehicledata($vehicleId) {
    include 'pages/vehicle.php';
    $vehicledata = getVehicleForVehicleDashboard($vehicleId);
