...
<style>
    #proposedtransporterindentskumaster_filter{display: none}
...
<div class='container' >
    ...
    <div style="float:right;">
        <a href="tms.php?pg=view-proposed-transporter"> <button class="btn-primary" style="margin:5px; width:auto; display: inline-block;">Back To Proposed Indents</button></a>
    </div>
...
<div class='container' >
    <center>
        ...
        <table class='display table table-bordered table-striped table-condensed' id="proposedtransporterindentskumaster" >
            <thead>
                <tr>
...
<script type='text/javascript'>
    ...
    var tableId = 'proposedtransporterindentskumaster';
    var tableCols = [
         {"mData": "skucode"}
