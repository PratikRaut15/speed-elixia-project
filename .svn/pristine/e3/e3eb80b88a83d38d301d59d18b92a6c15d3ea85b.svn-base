...
//$thiscustomerno = '30';
        ...
        $users = $um->getusersforcustomerfortravelhistcsv($thiscustomerno);
        if(isset($users))
        {
...
//                            $date = date("d-m-Y");
                            ob_start();
                            $geocode = '1';
                            $cat=substr(get_travel_history_report_csv($user->customerno,$vehicle->vehicleid,$date,$date,$geocode),-4);
                            $cat = trim($cat);
                                                ...
                                                if(!file_exists($filename1))
                                                    {
                                                        ...
                                                        $directory = $serverpath."/customer/".$user->customerno."/unitno/".$vehicle->unitno."/csv/".$cat."_".$date."_travelhistory.xls";
