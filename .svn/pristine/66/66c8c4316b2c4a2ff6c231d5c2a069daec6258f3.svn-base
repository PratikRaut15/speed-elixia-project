INSERT INTO `dbpatches` (
    ...
    `patchdesc` ,
    `isapplied`)
VALUES ('643', '2018-12-18 12:10:00','Manasvi Thakur','Update purchase unit SP', '0');
...
CREATE PROCEDURE `purchase_unit`(
    ...
    ,IN tempReadTypeParam INT(11)
    ,IN fuelMinVoltParam INT(11)
    ,IN fuelMaxVoltParam INT(11)
    ,IN fuelCapacityParam INT(11)
        ...
        BEGIN
            ...
            IF chalaannoParam <> '' THEN
                ...
                VALUES(unitidVar
                    ...
                    ,todayParam);
            END IF;
            IF fuelMinVoltParam != 'NULL' AND fuelMaxVoltParam != 'NULL' AND fuelCapacityParam != 'NULL' THEN
                UPDATE vehicle
                SET
                fuel_min_volt = fuelMinVoltParam
                ,fuel_max_volt = fuelMaxVoltParam
                ,fuel_capacity = fuelCapacityParam
                WHERE uid = unitidVar;
            END IF;
            SET isexecutedOut = 1;
