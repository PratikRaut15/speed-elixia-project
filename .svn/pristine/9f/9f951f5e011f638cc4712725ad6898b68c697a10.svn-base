...
class GetLatestVehicleResponse {
    ...
    function __construct($arrResponse){
        $this->warehouse = isset($arrResponse['vehicleno']) ? $arrResponse['vehicleno'] : '';
        $this->warehouseid = isset($arrResponse['vehicleid']) ? $arrResponse['vehicleid'] : '';
        ...
        $this->warehousestatus = isset($arrResponse['vehiclestatus']) ? $arrResponse['vehiclestatus'] : '';
