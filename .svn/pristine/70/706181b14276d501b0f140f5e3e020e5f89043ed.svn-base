...
<script>
    ...
    $(".page-header").html("<span style='font-size:28px; '>Operational Dashboard</span>");
    $('.container').focus();
});
</script>
<style type="text/css">
...
<div class="page">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div id="myGrid" style="height:400px;text-align: left;" class="ag-theme-blue"></div>
            </div>
        </div>
    </div>
</div>
      ...
      Object
        ...
        .map(key => {
          let mappedColumn = {
            ...
            width:(key == 'srno') ? 80 : (key == 'vehicleNo') ? 160 : 350,
          }
