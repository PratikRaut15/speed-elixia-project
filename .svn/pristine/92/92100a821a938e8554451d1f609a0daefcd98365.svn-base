/*
    Name			-	map_vehicle_user_driver
    Description 	-	To get SMS logs for particular customer
    Parameters		-	customerno, vehicleidparam, useridparam,driveridparam,drivername,todaysdate
    Module			-	Vehicle Tracking System
    Sub-Modules 	- 	Driver Mapping APP
    Sample Call		-	CALL map_vehicle_user_driver('2','2785','110,1152,1265,1335','397','','2015-12-19 17:32:52');
						CALL map_vehicle_user_driver('2','2785','110','0','Driver','2015-12-19 17:32:52');
    Created by		-	Mrudang
    Created on		- 	8 Dec, 2015
    Change details 	-	
    1) 	Updated by	- 	Shrikant
		Updated	on	- 	8 Dec, 2015
        Reason		-	Not Allocated Driver Mapping For Demapped Vehicle.
    2)  Updated by	- 	Mrudang
		Updated	on	- 	15 Dec, 2015 and 19 Dec, 2015
        Reason		-	Map multipe users in same car. (Club users enhancement).
	3)  Updated by	- 	Mrudang
		Updated	on	- 	29 Dec, 2015 and 19 Dec, 2015
        Reason		-	set limit 1 for select into queries. (Club users enhancement).
	4)  Updated by	- 	Mrudang
		Updated	on	- 	15 Jan, 2016
        Reason		-	Added userid in return select statement for sms logging.
	5)  Updated by	- 	Mrudang
		Updated	on	- 	09 Feb, 2016
        Reason		-	De-mapped the existing driver before demapping the exsiting vehicle.
*/
DELIMITER $$
