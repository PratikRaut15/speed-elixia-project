...
ALTER TABLE probity_master ADD customerno int(11) NOT NULL AFTER work_master;
...
(20, '728', 'Lilabai Kasbe Road', 'static_19.sqlite', 21),
(21, '732', 'Road no 1 Arora Cinema Matiunga Lane', 'static_20.sqlite', 21),
(22, '703', 'J K Basin Marg', 'static_21.sqlite', 21),
...
INSERT INTO `dbpatches` ( `patchid`, `patchdate`, `appliedby`, `patchdesc`) 
 VALUES ( 213, NOW(), 'Shrikanth Suryawanshi','Probity Changes');
