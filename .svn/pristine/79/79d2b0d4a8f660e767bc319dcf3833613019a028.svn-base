...
<div class="container-fluid">
  ...
  <table class='display' id="assignUserOrders" >
    <thead>
      <tr>
        ...
        <td><input type="text" class='search_init' name='fulfillmentid' id="txtfulfillment" style='width:80px;'/></td>
        <td><input type="text" class='search_init' name='pickup' id="txtpickup" style='width:80px;'/></td>
        <td><input type="text" class='search_init' name='pickup' id="txtpickup" style='width:80px;'/></td>
        <td><input type="text" class='search_init' name='pickup' id="txtpickup" style='width:80px;'/></td>
        <td><input type="text" class='search_init' name='pickupdate' id="DelDate" value="<?php echo $today; ?>" style='width:80px;'/></td>       <td><input type="text" class='search_init' name='status' id="txtstatus" style='width:80px;'/></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <th>Order ID.</th>
