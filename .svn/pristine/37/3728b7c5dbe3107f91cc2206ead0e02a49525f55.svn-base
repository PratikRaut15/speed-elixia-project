...
{
    if($_GET['id']==1)
        echo "<li><a class='selected' href='pickup.php?id=1'>Add Pickup Boy</a></li>";
    else
        echo "<li><a href='pickup.php?id=1'>Add Pickup Boy</a></li>";
    if($_GET['id']==2)
        echo "<li><a class='selected' href='pickup.php?id=2'>View Pickup Boy</a></li>";
    else
        echo "<li><a href='pickup.php?id=2'>View Pickup Boy</a></li>";
    if($_GET['id']==3){
        @$uid= $_GET["uid"];
