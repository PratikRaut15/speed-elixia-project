...
<style>
  #planteff_filter{display: none}
  .dataTables_length{display: none}
</style>
<br/>
<div class='container' >
  <center>
    <h3>Plant Wise Placement Efficiency </h3>
    ...
    <table class='display table table-bordered table-striped table-condensed' id="planteff" style="width: 80%;" >
      <thead>
        <tr>
...
<script type='text/javascript'>
 var data = <?php echo json_encode($factoryEffArray); ?>;
 var tableId = 'planteff';
 var tableCols = [
   {"mData": "factoryname"}
