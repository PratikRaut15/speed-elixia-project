...
$site_url = "";
$use_ssl = false;
$googleMapSpeedKey = 'AIzaSyCIdi3tTTXB0Gtkj0pKEdQbijxZNJF2psU';
...
define("GOOGLE_MAP_API_KEY", $googleMapSpeedKey); // Place your Google API Key for notifications
