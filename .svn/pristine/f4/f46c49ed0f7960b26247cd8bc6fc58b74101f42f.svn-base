...
<div class='container' >
    <center>
        <form id="addorders" method="POST" action="" onsubmit="addOrders();
                return false;" enctype='application/json'>
            <table class='table table-condensed'>
                ...
                <tr><td class='frmlblTd'>Slot</td><td><input type="text" name="slot" ></td></tr>
                ...
                <tr><td class='frmlblTd'>Flat</td><td> <input type="text" name="flat"></td></tr>
                ...
                <tr><td class='frmlblTd'>Pincode</td><td><input type="text" name="pincode" ></td></tr>
                <tr><td class='frmlblTd'>Delivery Date</td><td><input type="text" name="delivery_date" id="delivery_date"></td></tr>
                <tr><td class='frmlblTd'>Total Amount</td><td><input type="text" name="total_amount" ></td></tr>
                <tr><td class='frmlblTd'>Redeem Limit</td><td><input type="text" name="redeem_limit" ></td></tr>
                <tr><td class='frmlblTd'>Customer Name</td><td><input type="text" name="customername" ></td></tr>
