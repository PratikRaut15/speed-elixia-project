...
define("CUSTOMERID","Cust10010");
define("AKSHAR_TRACKING_URL", "portal.akshartrackingsolutions.com/imei.asmx/reportsdemo?customerid=");
...
die;*/
$jsonResponse = array();
$apiConstant = AKSHAR_TRACKING_URL;
...
if(isset($apiConstant) && $apiConstant!=""){
    if ($action == "getAllVehicleData") {
        ...
        //Resource Address
        $url = AKSHAR_TRACKING_URL.CUSTOMERID;                          
