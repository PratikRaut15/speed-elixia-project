        ...
        <div id='informaticsStart'>
          ...
          <!--            <div style='float:left'>Total Installed Devices: <b><?php // echo $device_installed_display;                               ?></b></div>-->
            ...
            <table id="tblInfo" align='center' style='width: 90%; font-size:13px; text-align:center;border:1px solid #000;'>
                ...
                <tr><td colspan="7"><br/></td></tr>
                <tr>
                    <td colspan="9"><strong><?php echo $currentMonthName; ?></strong></td>
                </tr>
                <tr>
                    <td colspan="9"><strong>Weekend / Holiday Trip</strong></td>
                </tr>
                <tr>
                    <td colspan="9">
                        <table style='font-size:13px; text-align:center;border:1px solid #000;'>
                            ...
                            <tr><td colspan='9' class="redtd">Red Zone</td></tr>
                            <?php
                            foreach ($arrData as $data) {
                                if ($data['isRed'] > 0) {
                                    ?>
                            ...
                            ?>
                            <tr><td colspan='9' class="yellowtd">Yellow Zone</td></tr>
                            <?php
                            foreach ($arrData as $data) {
                            ...
                            ?>
                            <tr><td colspan='9' class="greentd">Green Zone</td></tr>
                            <?php
                            foreach ($arrData as $data) {
