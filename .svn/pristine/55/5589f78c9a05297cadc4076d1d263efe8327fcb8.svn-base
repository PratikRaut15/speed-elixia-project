...
<div class="panel" style="width:100%;">
    <div class="paneltitle" align="center" style="width:100%;">Active Pipelines</div>
...
$db = new DatabaseManager();
    $SQL = sprintf("SELECT  sp.pipelineid
                    ...
                    WHERE   sp.isdeleted = 0 AND sp.stageid NOT IN (9,10,12) %s 
    ...
    if ($db->get_rowCount() > 0) {
        ...
        while ($row = $db->get_nextRow()) {
            ...
            $delete_url = "<a href='javascript:void(0);' alt='Delete' title='Delete' onclick='deletepipeline(" . $pipelineid . ");'><img style='text-align:center; width:20px; height:20px;' src='../../images/delete_icon_black.png'/></a>";
...
<script>
    ...
    function deleteCellRenderer(params){
        return "<a href='javascript:void(0);' alt='Delete' title='Delete' target='_blank' onclick='deletepipeline(" +params.data.pipelineid+ ");'><img style='height:25px;padding:7px;' src='../../images/delete_icon_black.png'/></a>"
    }

    function editCellRenderer(params){
        return "<a href='modify_pipeline.php?pipelineid="+params.data.pipelineid+"' target='_blank' alt='Edit' title='Edit' ><img style='height:25px;padding:7px;' src='../../images/edit_icon_black.png'/></a>"
    }
