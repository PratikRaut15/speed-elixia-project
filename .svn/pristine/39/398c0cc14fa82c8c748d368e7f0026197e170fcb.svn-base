...
$columns = array(
    ...
    array('db' => 'b.order_id', 'dt' => 4),
    array('db' => 'z.zonename', 'dt'=> 5),
    array('db' => 'concat_ws(",", msa.flat, msa.building,msa.landmark,am.areaname,msa.city) as address', 'dt'=> 6, 'alias'=>'address'),
    array('db' => 'a.vehicle_id', 'dt'=> 7),
