<table>
    <thead>
    <tr>
        <th id="formheader" colspan="100%">Idle-time Analysis Report</th>
    </tr>
    </thead>
    <tbody>
    <tr>
        <td colspan="100%">
            ...
            <span id="error4" name="error3" style="display: none;">Date Selection Difference Not More Than 30 Days</span>
