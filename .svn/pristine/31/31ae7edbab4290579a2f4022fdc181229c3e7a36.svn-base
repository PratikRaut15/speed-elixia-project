<table>
    ...
    <tr>
        <td colspan="100%">
            ...
            <span id="error7" name="error7" style="display: none;">Please Select Digital Sensor</span>
            <span id="error8" name="error8" style="display: none;">Sensor Not Available</span>
            <span id="error9" name="error9" style="display: none;">Sensor Not Available</span>
            <span id="error10" name="error10" style="display: none;">Sensor Not Available</span>
            <span id="error11" name="error11" style="display: none;">Sensor Not Available</span>
        </td>
    </tr>
