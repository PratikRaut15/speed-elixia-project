<table>
    <thead>
    <tr>
        <th id="formheader" colspan="100%">Location Analysis Report</th>
    </tr>
    </thead>
    <tbody>
    <tr>
        <td colspan="100%">
            ...
            <span id="error4" name="error4" style="display: none;">Selected Date Difference Is Not More Than 30 Days</span>
