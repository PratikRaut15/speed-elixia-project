...
function editvehicles_forapproval(vehicle_id, userid)
{
        ...
        jQuery.ajax({
            ...
            success: function (statuscheck) {
                if (statuscheck == "notok") {
                    ...
                    jQuery("#general_complete").val('done');
                    approved_new(vehicle_id, userid);
                    //jQuery("#general_success").show();
                    //jQuery("#general_success").fadeOut(6000);
                    //alert("test");
...
function editvehicles_forapproval_trigon(vehicle_id, userid)
{
    ...
    jQuery.ajax({
        ...
        success: function (statuscheck) {
            if (statuscheck == "notok") {
                ...
                jQuery("#general_complete").val('done');
                approved_new_trigon(vehicle_id, userid);
            }
        }
    });
...
function editgeo()
{
    var vehicleid = jQuery('#edit_vehicle_id').val();
    if (vehicleid != '') {
        var data = jQuery('#geo_form').serialize() + '&editgeo_vehicleid=' + vehicleid;
        jQuery.ajax({
            url: "route_ajax.php",
            type: 'POST',
            cache: false,
...
function addaccessory_history()
{
    ...
    else if (amount_quote > 22500)
    {
        ...
        {
            accessory_list.push(jQuery("#accessory_select_1").val() + "-" + jQuery("#amount1").val());
        }
        if (jQuery("#accessory_select_2").val() != "-1")
        {
            accessory_list.push(jQuery("#accessory_select_2").val() + "-" + jQuery("#amount2").val());
        }
        if (jQuery("#accessory_select_3").val() != "-1")
        {
            accessory_list.push(jQuery("#accessory_select_3").val() + "-" + jQuery("#amount3").val());
        }
        if (jQuery("#accessory_select_4").val() != "-1")
        {
            accessory_list.push(jQuery("#accessory_select_4").val() + "-" + jQuery("#amount4").val());
        }
        if (jQuery("#accessory_select_5").val() != "-1")
        {
            accessory_list.push(jQuery("#accessory_select_5").val() + "-" + jQuery("#amount5").val());
        }
        if (jQuery("#accessory_select_6").val() != "-1")
        {
            accessory_list.push(jQuery("#accessory_select_6").val() + "-" + jQuery("#amount6").val());
        }
        if (jQuery("#accessory_select_7").val() != "-1")
        {
            accessory_list.push(jQuery("#accessory_select_7").val() + "-" + jQuery("#amount7").val());
        }
...
function uploadFilesPUCx(event)
{
    if (jQuery('#puc').val() != '') {
        ...
        files = null;
        jQuery.ajax({
            url: 'upload.php?vehicleid=' + edit_vehicle_id + '&pucname=' + puc + '&puc',
            type: 'POST',
            data: data,
            cache: false,
            dataType: 'json',
...
function uploadFilesREG(event)
{
    if (jQuery('#reg').val() != '') {
        ...
        files_reg = null;
        jQuery.ajax({
            url: 'upload.php?vehicleid=' + edit_vehicle_id + '&reg',
            type: 'POST',
            data: datareg,
            cache: false,
            dataType: 'json',
...
function uploadFilesINS(event)
{
    if (jQuery('#insurance').val() != '') {
        ...
        files_ins = null;
        jQuery.ajax({
            url: 'upload.php?vehicleid=' + edit_vehicle_id + '&ins',
            type: 'POST',
            data: datains,
            cache: false,
            dataType: 'json',
...
function submitForm_Other(event, data)
{
    ...
    //var formData = jQuery('#editpapers').serialize();
...
function approved(vehicle_id)
{
    var notes = jQuery('#approved_notes').val();
    if (notes == "")
    {
        jQuery("#notes_comp").show();
        jQuery("#notes_comp").fadeOut(3000);
    }
    else
    {
        if (vehicle_id != '') {
            ...
            jQuery.ajax({
                ...
                type: 'POST',
                cache: false,
                data: {vehicleid: vehicle_id, notes: notes, work: 'approved'},
                dataType: 'html',
                success: function (data) {
                    window.location.href = "approvals.php?id=1";
                }
            });
            return false;
        }
        else {
            alert('please check the vehicle id!!');
        }
    }
}
function approved_new(vehicle_id, userid)
{
    // editvehicles();
    var notes = jQuery('#approved_notes').val();
    if (notes == "")
    ...
    else
    {
        ...
        if (vehicle_id != '') {
            ...
            jQuery.ajax({
                ...
                type: 'POST',
                cache: false,
                data: {vehicleid: vehicle_id, notes: notes, user_id: userid, work: 'approved'},
                dataType: 'html',
                success: function (data) {
                    window.location.href = "approvals.php?id=1";
...
function approved_new_trigon(vehicle_id, userid)
{


    // editvehicles();
    var notes = jQuery('#approved_notes').val();
    var veh_notes = jQuery('#notes').val();
    if (notes == "")
    {
        jQuery("#notes_comp").show();
        jQuery("#notes_comp").fadeOut(5000);
    ...
    else
    {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            cache: false,
            data: {vehicleid: vehicle_id, notes: notes, veh_notes: veh_notes, user_id: userid, work: 'approved'},
            dataType: 'html',
            success: function (data) {
                window.location.href = "approvals.php?id=1";
    ...
    else
    {
        if (vehicle_id != '') {
            ...
            jQuery.ajax({
                ...
                type: 'POST',
                cache: false,
                data: {vehicleid: vehicle_id, notes: notes, work: 'reject'},
                dataType: 'html',
                success: function (data) {
                    window.location.href = "approvals.php?id=1";
                }
...
function reject_new(vehicle_id, userid)
{
    //editvehicles();
    var notes = jQuery('#approved_notes').val();
    if (notes == "")
    ...
    else
    {
        ...
        if (vehicle_id != '') {
            ...
            jQuery.ajax({
                ...
                type: 'POST',
                cache: false,
                data: {vehicleid: vehicle_id, notes: notes, user_id: userid, work: 'reject'},
                dataType: 'html',
                success: function (data) {
                    window.location.href = "approvals.php?id=1";
                }
...
function reject_new_trigon(vehicle_id, userid)
{
    ...
    jQuery.ajax({
        ...
        type: 'POST',
        cache: false,
        data: {vehicleid: vehicle_id, veh_notes: veh_notes, notes: notes, user_id: userid, work: 'reject'},
        dataType: 'html',
        success: function (data) {
            window.location.href = "approvals.php?id=1";
        }
...
{
    var oth3expiry = jQuery("#ExpiryDate_OTH4").val();
