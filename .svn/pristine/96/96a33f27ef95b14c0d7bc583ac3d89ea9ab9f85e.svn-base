  ...
  <table style="width: 1120px;  border:1px solid;background-color:#CCCCCC;border-collapse:collapse;">
    <tr>
      <td colspan="5" style="width:1120px; text-align: center; text-transform:uppercase;">
        <h4 style="text-transform:uppercase;">Informatics</h4>
      </td>
    </tr>
    <tr>
      <td colspan="2" style="text-align:left;font-weight:bold;">
        Start Date:  <?php echo date(speedConstants::DEFAULT_DATE, strtotime($s_date)); ?><br/>
        End Date: <?php echo date(speedConstants::DEFAULT_DATE, strtotime($e_date)); ?> <br/>
      </td>
 ...
 if (validate_input($s_date, $e_date)) {
  ...
  <div id='informaticsStart'>
    ...
    <div style='float:left'>
      ...
      <div style='float:left;'>
        Average Distance Travelled(Per day): <b><?php
          if (isset($kms_tracked['avg_dis_trav'])) {
           echo round($kms_tracked['avg_dis_trav']);
          } else {
           echo 0;
          }
          ?>kms</b>
      ...
      <div style='float:left;'>
        Average Distance Travelled(Per day & Vehicles): <b><?php
          if (isset($kms_tracked['avg_dis_trav_veh'])) {
           echo round($kms_tracked['avg_dis_trav_veh']);
          } else {
           echo 0;
          }
          ?>kms</b>
    ...
    <div style='float:left'>
      <div style='float:left;'>
        Total no. of kms travelled on Sundays: <b><?php
          if (isset($kms_tracked['sun_dis_trav'])) {
           echo round($kms_tracked['sun_dis_trav']);
          } else {
           echo 0;
          }
          ?>kms</b>
      ...
      <table align='center' style='width: auto; font-size:13px; text-align:center;border:1px solid #000;'>
        <tbody>
          <?php
          $unique_dates = array_unique($kms_tracked['unique_dates']);
    ...
    <div style='float:left;'>
      <div style='float:left;'>
        Total no. of harsh breaks: <b><?php
          if (isset($overspeed_data['harsh_break'])) {
           echo $overspeed_data['harsh_break'];
          } else {
           echo 0;
          }
          ?></b>
      ...
      <div style='float:left;'>
        Sudden change of acceleration during day (7 am to 8 pm): <b><?php
          if (isset($overspeed_data['acc_day'])) {
           echo $overspeed_data['acc_day'];
          } else {
           echo 0;
          }
          ?></b>
      ...
      <div style='float:left;'>
        Sudden change of acceleration during night (8 pm to 7 am): <b><?php
          if (isset($overspeed_data['acc_night'])) {
           echo $overspeed_data['acc_night'];
          } else {
           echo 0;
          }
          ?></b>
      ...
      <!--<div style='float:left;'>
          Total no. of Sharp turn: <b><?php
      if (isset($overspeed_data['sharp_turn'])) {
       echo $overspeed_data['sharp_turn'];
      } else {
       echo 0;
      }
      ?></b>
      ...
      <div style='float:left;'>
        Total no. of Towing: <b><?php
          if (isset($overspeed_data['towing'])) {
           echo $overspeed_data['towing'];
          } else {
           echo 0;
          }
          ?></b>
    ...
    <div style='float:left'>
      <div style='float:left;'>
        No. of incidents recorded: <b><?php
          $inc_recrd = get_comqueue_count($start_date, $end_date);
          echo $inc_recrd['total'];
          ?></b>
      </div><br>
      <table align='center' style='width: auto; font-size:13px; text-align:center;border:1px solid #000;'>
        <tbody>
    ...
    <div style='float:left'>
      <div style='float:left;'>
        Total Idle Tim(All Vehicles)e: <b><?php
          if (isset($kms_tracked['total_idle_time'])) {
           echo $kms_tracked['total_idle_time'];
          } else {
           echo 0;
          }
          ?></b>
      ...
      <div style='float:left;'>
        Total Running Time(All Vehicles): <b><?php
          if (isset($kms_tracked['total_running_time'])) {
           echo $kms_tracked['total_running_time'];
          } else {
           echo 0;
          }
          ?></b>
...
//echo $content;
$xls_filename = date("d-m-Y") . "_Informatics_Report.xls";
