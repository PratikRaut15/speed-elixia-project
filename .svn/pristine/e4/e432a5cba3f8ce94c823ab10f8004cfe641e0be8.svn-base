    ...
    <form enctype="multipart/form-data" method="post" class="form-horizontal well " onsubmit='return validate_upload("studentFile");'  style="width:70%;">
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="100%"><span class="add-on"> Please Download The Sample Excel Sheet For Import Student Data.
                    <span class="mandatory">*</span>  <a href='student.xls' target="_blank">  Download Excel Sheet</a></span></td>
                </tr>
            </tbody>
        </table>
    </form>
