...
<div class="tabbable tabs-left" style="width: 70%; clear: both">
    ...
    <input type="button" id='sendapproval' onclick="sendapproval();" value="Send For Approval" class="btn btn-success">
...
<br/><br/>
        ...
        <div class="tab-content">
          ...
          <span id="branch_error" style="display:none; color: #FF0000">Please Select Branch.</span>
                                ...
                                <span class="add-on">Vehicle No. <span style="color:#FE2E2E; ">*</span></span><input type="text" name="edit_vehicle_no" id="edit_vehicle_no" placeholder="Vehicle No" value="<?php echo $general->vehicleno; ?>" autofocus maxlength="10" OnKeyPress="return nospecialchars(event)">
                                <span class="add-on">Kind</span><select id="kind" name="kind">
                                                                        ...
                                                                        <option value='SUV' <?php if($general->kind == 'SUV'){ echo 'selected="selected"';}?> >SUV</option>
                                ...
                                <span class="add-on">Year of Manufacture</span><input type="text" value="<?php echo $general->manufacturing_year; ?>" name="yearofman" id="yearofman" placeholder="e.g. 2011" maxlength="4" >
                                ...
                                <div class="input-prepend formSep ">
                                <span class="add-on"><?php echo($_SESSION['group']); ?> <?php if($_SESSION['use_hierarchy'] == '1') { ?><span style="color:#FE2E2E; ">*</span> <?php } ?></span><select id="branchid" name="branchid" <?php if($_SESSION['use_hierarchy'] == '1') { ?> onchange="showbranch()" <?php } ?>>
                                ...
                                <span class="add-on">Overspeed Limit</span><input type="text" name="overspeed" value="<?php echo $general->overspeed_limit; ?>" id="overspeed" placeholder="Overspeed Limit" maxlength="20" value="80" readonly/>
...
<!--			<div class="form-group">
          ...
          <span id="invoice_year_error" style="display:none; color: #FF0000">Invoice Year cannot be less than Year of Manufacture.</span>           
                                <div class="input-prepend">
                                <span class="add-on">Engine No.</span><input type="text" name="edit_engineno" id="edit_engineno" value="<?php echo $description->engineno; ?>" placeholder="engine no." maxlength="20" OnKeyPress="return nospecialchars(event)">
                                <span class="add-on">Chasis No.</span><input type="text" name="chasisno" id="chasisno" value="<?php echo $description->chasisno; ?>" placeholder="chasis no." maxlength="20" OnKeyPress="return nospecialchars(event)">
                                </div>
                                    <br/>
                                <div class="input-prepend formSep ">
                                ...
                                <span class="add-on">Dealer Name</span><select id="dealerid" name="dealerid" onchange="showdealer()">
                                                                    ...
                                                                    <?php $invoicedate = date('d-m-Y',  strtotime($description->invoicedate));
                                ...
                                <span class="add-on">Code</span><input type="text" name="code_dealer" value="<?php echo $dealer_data->code; ?>" readonly id="code_dealer">
                                    <br/><br/>
                                <span class="add-on">Invoice No.</span><input type="text" value="<?php echo $description->invoiceno; ?>" name="invoiceno" id="invoiceno" placeholder="12586" maxlength="10" OnKeyPress="return nospecialchars(event)">
			...
			<div class="input-prepend">
                           <span class="add-on">Value of Insurance</span><input type="text" name="insurance_value" id="insurance_value" value="<?php echo $insurance->value; ?>" maxlength="10" >
                           <span class="add-on">Premium</span><input type="text" name="premium_value" id="premium_value" value="<?php echo $insurance->premium; ?>" maxlength="10" >
                           </div>	
                            <br>
			<div class="input-prepend">
...
<!--                            <span class="add-on">Amount</span><input type="text" name="ins_amount" id="ins_amount" value="<?php // echo $insurance->amount; ?>"> -->
                           <span class="add-on">Notes</span><input type="text" name="ins_notes" id="ins_notes" value="<?php echo $insurance->notes; ?>" maxlength="20" OnKeyPress="return nospecialchars(event)">
			...
			<div class="input-prepend formSep">
                           ...
                           <span class="add-on">Nearest Place Of Claim</span> <input type="text" name="near_place" placeholder="e.g. mumbai, delhi" id="near_place" value="<?php echo $insurance->claim_place; ?>" maxlength="20" OnKeyPress="return nospecialchars(event)">
                        </div>
			...
			<div class="input-prepend formSep ">
                        ...
                        <span class="add-on">Cost</span> <input type="text" name="edit_cap_cost" id="edit_cap_cost" value="<?php echo $capitalization->cost; ?>" value="0" />
                        <span class="add-on">Current Ratio (Maintenance / Capitalization)</span> <input type="text" name="cap_code" value="<?php echo $capitalization->maintenance_percent; ?>" readonly id="cap_code" />
                        <input type="hidden" name="additional_main_amount" value="0" id="additional_main_amount" />
                        
                        </div>	
                            <br>
			<div class="input-prepend">
                            <span class="add-on">Address</span> <textarea name="cap_address" id="cap_address" maxlength="200" OnKeyPress="return nospecialchars(event)"><?php echo $capitalization->address; ?></textarea>
                        </div>
			...
			<div class="input-prepend">  
                       ...
                       ?>
                        ...
                        <select id="ExpiryDate_PUC_rem">
                            <option value="-1"<?php if($alert['puc_sms_email']==-1){ echo "Selected";}?>>Never Remind me</option>
                            <option value="0" <?php if($alert['puc_sms_email']==0){ echo "Selected";}?>>Remind me on the day of Expiry</option>
                            <option value="1" <?php if($alert['puc_sms_email']==1){ echo "Selected";}?>>Remind me 1 day prior to Expiry</option>
                            <option value="2" <?php if($alert['puc_sms_email']==2){ echo "Selected";}?>>Remind me 2 days prior to Expiry</option>
                            <option value="7" <?php if($alert['puc_sms_email']==7){ echo "Selected";}?>>Remind me 1 week prior to Expiry</option>                            
                            <option value="30" <?php if($alert['puc_sms_email']==30){ echo "Selected";}?>>Remind me 1 month prior to Expiry</option>                            
                        </select>
                        &nbsp;
			...
			<div class="input-prepend">
                       ...
                       ?>
                        ...
                        <select id="ExpiryDate_REG_rem">
                            <option value="-1" <?php if($alert['reg_sms_email']==-1){ echo "Selected";}?>>Never Remind me</option>
                            <option value="0" <?php if($alert['reg_sms_email']==0){ echo "Selected";}?>>Remind me on the day of Expiry</option>
                            <option value="1" <?php if($alert['reg_sms_email']==1){ echo "Selected";}?>>Remind me 1 day prior to Expiry</option>
                            <option value="2" <?php if($alert['reg_sms_email']==2){ echo "Selected";}?>>Remind me 2 days prior to Expiry</option>
                            <option value="7" <?php if($alert['reg_sms_email']==7){ echo "Selected";}?>>Remind me 1 week prior to Expiry</option>
                             <option value="30" <?php if($alert['puc_sms_email']==30){ echo "Selected";}?>>Remind me 1 month prior to Expiry</option>
                        </select>
                        &nbsp;
			...
			<div class="input-prepend"> 
                       ...
                       ?>
                        ...
                        <select id="ExpiryDate_INS_rem">
                            <option value="-1" <?php if($alert['insurance_sms_email']==-1){ echo "Selected";}?>>Never Remind me</option>
                            <option value="0" <?php if($alert['insurance_sms_email']==0){ echo "Selected";}?>>Remind me on the day of Expiry</option>
                            <option value="1" <?php if($alert['insurance_sms_email']==1){ echo "Selected";}?>>Remind me 1 day prior to Expiry</option>
                            <option value="2" <?php if($alert['insurance_sms_email']==2){ echo "Selected";}?>>Remind me 2 days prior to Expiry</option>
                            <option value="7" <?php if($alert['insurance_sms_email']==7){ echo "Selected";}?>>Remind me 1 week prior to Expiry</option> 
                             <option value="30" <?php if($alert['puc_sms_email']==30){ echo "Selected";}?>>Remind me 1 month prior to Expiry</option>
                        </select>
                        &nbsp;
			...
			<div class="input-prepend"> 
                       ...
                       ?>
                        ...
                        <select id="ExpiryDate_OTH1_rem">
                            <option value="-1" <?php if($alert['other1_sms_email']==-1){ echo "Selected";}?>>Never Remind me</option>
                            <option value="0" <?php if($alert['other1_sms_email']==0){ echo "Selected";}?>>Remind me on the day of Expiry</option>
                            <option value="1" <?php if($alert['other1_sms_email']==1){ echo "Selected";}?>>Remind me 1 day prior to Expiry</option>
                            <option value="2" <?php if($alert['other1_sms_email']==2){ echo "Selected";}?>>Remind me 2 days prior to Expiry</option>
                            <option value="7" <?php if($alert['other1_sms_email']==7){ echo "Selected";}?>>Remind me 1 week prior to Expiry</option>
                             <option value="30" <?php if($alert['puc_sms_email']==30){ echo "Selected";}?>>Remind me 1 month prior to Expiry</option>
                        </select>
                        &nbsp;
			...
			<div class="input-prepend"> 
                        ...
                        <span id="set_error_oth2" style="display:none;" class="btn btn-warning">Error, Please try again.</span>  
                         <?php
                       if($alert['other2_expiry'])
                       {
                          ?>
                        <span class="add-on" id="add_puc">Expiry Date </span><input id="ExpiryDate_OTH2" name="ExpiryDate_OTH2" type="text" class="input-small"  value="<?php echo date("d-m-Y", strtotime($alert['other2_expiry'])); ?>" required=""  />
                            <?php
                       }
                       else
                       {
                       ...
                       ?>
                        ...
                        <select id="ExpiryDate_OTH2_rem">
                             <option value="-1" <?php if($alert['other2_sms_email']==-1){ echo "Selected";}?>>Never Remind me</option>
                            <option value="0" <?php if($alert['other2_sms_email']==0){ echo "Selected";}?>>Remind me on the day of Expiry</option>
                            <option value="1" <?php if($alert['other2_sms_email']==1){ echo "Selected";}?>>Remind me 1 day prior to Expiry</option>
                            <option value="2" <?php if($alert['other2_sms_email']==2){ echo "Selected";}?>>Remind me 2 days prior to Expiry</option>
                            <option value="7" <?php if($alert['other2_sms_email']==7){ echo "Selected";}?>>Remind me 1 week prior to Expiry</option>
                             <option value="30" <?php if($alert['puc_sms_email']==30){ echo "Selected";}?>>Remind me 1 month prior to Expiry</option>
                        </select>
                        &nbsp;
			...
			<div class="input-prepend">
                       ...
                       ?>
                        ...
                        <select id="ExpiryDate_OTH3_rem">
                           <option value="-1" <?php if($alert['other3_sms_email']==-1){ echo "Selected";}?>>Never Remind me</option>
                            <option value="0" <?php if($alert['other3_sms_email']==0){ echo "Selected";}?>>Remind me on the day of Expiry</option>
                            <option value="1" <?php if($alert['other3_sms_email']==1){ echo "Selected";}?>>Remind me 1 day prior to Expiry</option>
                            <option value="2" <?php if($alert['other3_sms_email']==2){ echo "Selected";}?>>Remind me 2 days prior to Expiry</option>
                            <option value="7" <?php if($alert['other3_sms_email']==7){ echo "Selected";}?>>Remind me 1 week prior to Expiry</option>
                             <option value="30" <?php if($alert['puc_sms_email']==30){ echo "Selected";}?>>Remind me 1 month prior to Expiry</option>
                        </select>
                        &nbsp;
