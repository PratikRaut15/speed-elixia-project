/*1. Created By	     - Sanjeet
   Created On	     - 06-02-2019
   Reason    	     - Get All shops against SR  

2. Updated By	     - Sanjeet
   Updated On	     - 06-02-2019
   Reason    	     - Added below condition to fetch all shops against SR
			IF (dayIdParam = -1) THEN
			    SET dayIdParam = NULL;
			END IF;
 3.Updated By	     - Sanjeet
   Updated On	     - 22-02-2019
   Reason    	     -  Added Below Left join
...
CALL get_shops_by_sr('8879','-1','','698');
-- CALL get_shops_by_sr('8879','3','','698');
