...
function InsertDataInSqlite($vehData, $objVehDetail) {
    if ($objVehDetail->unitNo != "") {
        ...
        $db = "sqlite:" . RELATIVE_PATH_DOTS . "customer/" . speedConstants::CUSTNO_ALLANA . "/unitno/" . $objVehDetail->unitNo . "/sqlite/" . $date . ".sqlite";
        ...
        if(isset($objVehDetail->isValid) && $objVehDetail->isValid == 1){
