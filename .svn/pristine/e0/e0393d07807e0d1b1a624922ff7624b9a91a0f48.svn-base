...
$dg->AddAction("View/Edit", "../../images/edit.png", "modifybucket.php?id=%d");
...
<form method="post" action="bucketlist.php"  enctype="multipart/form-data">
<table>
        <?php
        $installation = date("d-m-Y", strtotime("+1 day"));
...
$df->AddAction("View/Edit", "../../images/edit.png", "modifybucket.php?id=%d");
