...
//     var category_type= jQuery("#category_type_edit option:selected").val();
    ...
    if(category_type==2 ||category_type==3){jQuery("#category_id").val(category_type);
    }
...
function addtyre()
{
        ...
        var vehicleid = jQuery('#edit_vehicle_id').val();var tyre_list=[];
          jQuery('.tyre_type_array').each(function(id,obj){
              tyre_list.push(obj.value);
          });
          // convering array into strin and assigning to the getstring url
...
function sendapproval_new_trigon(){
        var vehicle_id = jQuery('#edit_vehicle_id').val();
...
var files;
        ...
        function uploadFilesPUCx(event)
	{
            if(jQuery('#puc').val() != ''){
                ...
                files = null;
                jQuery.ajax({
                    url: 'upload.php?vehicleid='+edit_vehicle_id+'&puc',
                    type: 'POST',
                    data: data,
                    cache: false,
                    dataType: 'json',
...
var files_other1;
        ...
        function uploadFilesOTHER2(event)
	{
            ...
            if(jQuery('#other2_file').val() == ''){
                ...
                files_other2 = null;
                jQuery.ajax({
                    url: 'upload.php?vehicleid='+edit_vehicle_id+'&othername2='+othername2+'&other3',
                    type: 'POST',
                    data: dataother2,
                    cache: false,
                    dataType: 'json',
...
function ldchkpt(chkptname, chkptid)
{
    ...
    if (chkptid > -1 && jQuery('#to_checkpoint_div_' + chkptid).val() == null)
    {
        ...
        remove_image.src = "../../images/boxdelete.png";
        remove_image.className = 'clickimage';
        remove_image.onclick = function() {removechkpt(chkptid);};
        div.className = 'recipientbox';
