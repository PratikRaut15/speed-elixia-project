...
function loadrefresh()
{
    ...
    var isWareHouse = jQuery("#isWareHouse").val();
    ...
    var UrlSpc;
        ...
        UrlSpc = "rtd_map_ajax.php?all=1&userkey="+userkey+"&pageSize="+pageSize+"&pageIndex="+currentPage+"&isWareHouse="+isWareHouse+"&groupid="+groupid;
