        ...
        success: function(data) {
            ...
            jQuery.each(results, function(i, device) {
                ...
                google.maps.event.addListener(marker, "click", function(e) {
                    //ib.open(map, this);
                    alert('demo');
                    vehicleInfoBox(map, device.cvehicleid);
                });
            ...
            jQuery.ajax({
                ...
                success: function(data) {
                    ...
                    for (var key in cdata1) {
                        var route = [];
                        var keyInData = jQuery.parseJSON(cdata1[key].fence_bound);
...
function vehicleInfoBox(mapObj, vehicleId) {
    console.log(mapObj);
