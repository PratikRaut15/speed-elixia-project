jQuery(document).ready(function(){
   jQuery('#delivery_date').datepicker({format: "yyyy-mm-dd",autoclose:true,}); 
});
jQuery(function(){
...
function addOrders(){
    ...
    jQuery.ajax({url: '../../deliveryapi/delivery_v3.php',type:'POST',data:'bill='+final,async:false,success:function(response){
...
function editOrders(){
    ...
    var final = JSON.stringify(opts);
    jQuery.ajax({url: '../../deliveryapi/delivery_v3.php',type:'POST',data:'edit='+final,async:false,success:function(response){
            var obj = jQuery.parseJSON(response);
