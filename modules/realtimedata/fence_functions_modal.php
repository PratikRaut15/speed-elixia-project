...
function createfence($lat,$long,$fencename,$vehicle_array=null)
{   
...
function createfence_old($lat,$long,$fencename)
{
    $customerno = $_SESSION['customerno'];
    $userid = $_SESSION['userid'];
    $gm = new GeofenceManager($customerno);
...
function createfencebyvehicle_old($lat,$long,$fencename,$vehicle_array)
{
    $customerno = $_SESSION['customerno'];
    $userid = $_SESSION['userid'];
    $gm = new GeofenceManager($customerno);
