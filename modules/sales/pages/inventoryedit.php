...
$inventorydata = $mob->get_editinventorydata($invid);
...
<div class='container'>
    <center>
        <form name="editinventoryform" id="editinventoryform" method="POST" action="sales.php?pg=inventoryedit&invid=<?php echo $invid;?>" onsubmit="editinventory();
                return false;">
            <table class='table table-condensed'>
                <thead><tr><th colspan="100%" >Edit Inventory</th></tr></thead>
                <tbody>
            ...
            <tr><td colspan="100%" class='frmlblTd'><input type="submit" name="tracksubmit" value="Edit to Inventory" class='btn btn-primary'></td></tr>
            </tbody>
            </table>
            <?php
            if ($_SESSION['role_modal'] == "Distributor") {
