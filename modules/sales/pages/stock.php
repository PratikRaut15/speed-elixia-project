...
<div class='container'>
    <center>
        <form name="deadstockform" id="deadstockform" method="POST" action="sales.php?pg=stock" onsubmit="adddeadstock();
                return false;">
            <table class='table table-condensed'>
                <thead><tr><th colspan="100%" >Dead Stock </th></tr></thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="reason" id="reason" cols="50" rows="5" style="resize: none;"></textarea>
                        </td>
                    </tr>
                    ...
                    <tr><td colspan="100%" class='frmlblTd'><input type="submit" name="tracksubmit" value="Add to Dead Stock" class='btn btn-primary'></td></tr>
                </tbody>
            </table>
            <?php
            if ($_SESSION['role_modal'] == "sales_representative") {
