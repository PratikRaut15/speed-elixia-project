	...
	<div  >            
            <fieldset>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <?php if($battary['statusid']  == 6) { ?>
                        <tr>
                        <td>Approval Note</td><td><div id="acc_approval_note"><?php echo $battary['approve_notes'];?></div></td>
                        </tr> 
                        <?php  } ?>
                        <tr id="accident_ofasnumber_closed" style="display:none;">
                                                  
                        <td><?php echo $_SESSION['ref_number'];?></td><td><div id="accident_ofasnumber_value"></div></td>
                ...
                <div class="input-prepend ">
                    <input type="hidden" id="maintenanceid" name="maintenanceid" value="<?php echo $accid?>" />
