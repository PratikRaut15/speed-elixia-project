...
// $url = "localhost/elixia_speed/modules/api/gpsprovider/gtrac/consumeApi.php";

$customerNo = 206; //speedConstants::CUSTNO_SAFEANDSECURE;
...
function ProcessData($arrLatestVehData) {
    $objVehicleManager = new VehicleManager(speedConstants::CUSTNO_SAFEANDSECURE);
    foreach ($arrLatestVehData as $arrVehData) {
        ...
        if (isset($vehData)) {
            ...
            #########################################################################
                ...
                //Enter in Sqlite
                $objVehDetail->customerNo = speedConstants::CUSTNO_SAFEANDSECURE;
...
function InsertDataInSqlite($vehData, $objVehDetail) {
    if ($objVehDetail->unitNo != "") {
        ...
        $db = "sqlite:" . RELATIVE_PATH_DOTS . "customer/" . speedConstants::CUSTNO_SAFEANDSECURE . "/unitno/" . $objVehDetail->unitNo . "/sqlite/" . $date . ".sqlite";
        // echo $db; die;
