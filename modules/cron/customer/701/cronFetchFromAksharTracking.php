...
$arrHeaders[] = "Authorization: jzcTnCVCsrShmM74zKLR";

    $url = "http://speed.elixiatech.com/modules/api/gpsprovider/aksharTracking/consumeApi.php";
...
function ParseData($vehData) {
    ...
    $objVehDetail->vehNo = str_replace(" ", "", str_replace("-", "", $vehData->vehicleno));
    ...
    $objVehDetail->odometer = isset($vehData->CurrentKms) ? $vehData->CurrentKms*1000 : 0;
    ...
    $objVehDetail->lastUpdated = date('Y-m-d H:i:s',strtotime($vehData->timerecorded));
    //TODO
