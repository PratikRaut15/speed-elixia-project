...
$objVendorDetails->userName = "mondelez";
...
function InsertDataInSqlite($vehData, $objVehDetail) {
    if ($objVehDetail->unitNo != "") {
        ...
        $db = "sqlite:" . RELATIVE_PATH_DOTS . "customer/" . speedConstants::CUSTNO_SAHARA_ROADLINES . "/unitno/" . $objVehDetail->unitNo . "/sqlite/" . $date . ".sqlite";
