...
// $objJsonReq->apiUrl = "http://latlong.net.in/Client/LatLong_WebService-CCSI.asmx?wsdl"; // remark, we have used "?wsdl" for xml api

$objJsonReq->apiUrl = "http://latlong.net.in/Client/LatLong_CCSI_SE.asmx"; 
$objJsonReq->isGetDataByDateTime = "1"; // (1) for get data from fromDateTime to toDtaeTime
$objJsonReq->customerNo = speedConstants::CUSTNO_CCSI_LOGISTICS;
...
function ProcessData($arrLatestVehData, $isGetDataByDateTime=0) {
    $objVehicleManager = new VehicleManager(speedConstants::CUSTNO_CCSI_LOGISTICS);
    foreach ($arrLatestVehData as $arrVehData) {
        ...
        if (isset($vehData)) {
            ...
            ################ Daily Report And Odometer Validation  ##################
                ...
                //Enter in Sqlite
                $objVehDetail->customerNo = speedConstants::CUSTNO_CCSI_LOGISTICS;
