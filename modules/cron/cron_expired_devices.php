...
/*
  Name		-       cron_expired_devices
  Description 	-	will send list of customer having expired devices to [accounts@elixiatech.com,sanketsheth1@gmail.com]..
...
foreach ($customernos as $data) {
    $detail[$data['customerno']] = $teammgr->getExpiredDevices($data['customerno']);
