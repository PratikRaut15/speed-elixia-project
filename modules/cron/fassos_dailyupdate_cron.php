...
//echo"<pre>";
//print_r($grouplistdata); die();
$message = 'Daily Compliance Report - ' . date('d-M-Y', strtotime($prevdate));
$message .='<table border="1"><tr>'
        . '<th>City Name</th>'
        . '<th>Vertical Chiller NonVeg Temperature compliance % </th>'
        . '<th>Vertical Chiller Veg Temperature compliance % </th>'
        . '<th>Veg-Makeline Temperature compliance % </th>'
        . '<th>Non-veg makeline Temperature compliance % </th>'
        . '<th>Deep freezer 1 Temperature compliance % </th>'
        . '<th>Deep freezer 2 Temperature compliance % </th>'
        . '<th>Vigi Cooler compliance % </th>'
        . '</tr>';
if (isset($grouplistdata)) {
    foreach ($grouplistdata as $row) {
                ...
                if (is_array($temp_comp_data_for_vehicle) || is_object($temp_comp_data_for_vehicle)) {
                    ...
                    if (!empty($temp_comp_detail['vehicleno'])) {
                        $storemessage .="<tr><td style='background-color:#CCCCCC;'>" . $temp_comp_detail['vehicleno'] . "</td>"
                                . "<td>" . $vc_compliance_percent_store . "</td>"
                                . "<td>" . $vcv_compliance_percent_store . "</td>"
                                . "<td>" . $vml_compliance_percent_store . "</td>"
                                . "<td>" . $nvml_compliance_percent_store . "</td>"
                                . "<td>" . $deefs_compliance_percent_store . "</td>"
                                . "<td>" . $deefb_compliance_percent_store . "</td>"
                                . "<td>" . $vigicooler_compliance_percent_store . "</td>"
                                . "</tr>";
                        /*
                          $storemessage .="<tr><td style='background-color:#CCCCCC;'>" . $temp_comp_detail['vehicleno'] . "</td>"
        ...
        $message .="<tr><td style='background-color:yellow;'>" . $row['groupname'] . "</td>"
                . "<td>" . $vc_compliance_percent . "</td>"
                . "<td>" . $vcv_compliance_percent . "</td>"
                . "<td>" . $vml_compliance_percent . "</td>"
                . "<td>" . $nvml_compliance_percent . "</td>"
                . "<td>" . $deepfs_compliance_percent . "</td>"
                . "<td>" . $deepfb_compliance_percent . "</td>"
                . "<td>" . $vigicooler_compliance_percent . "</td>"
                . "</tr>";
...
$ext = ".xls";
$file_name = "citywise_fassos_dailyreport_" . date('d-M-Y', strtotime($prevdate)) . $ext;
...
$subject = "Daily Compliance Report - " . date('d-M-Y', strtotime($prevdate));
$toArr = array(
    //'ganeshp@elixiatech.com', 'sshrikanth@elixiatech.com',
    'vipin@faasos.com'
    , 'rohit@faasos.com'
    , 'pawan.lonikar@fassos.com'
	, 'siddhi.redkar@faasos.com'
	, 'ashwini.patil@faasos.com'
);
$CCEmail = '';
$BCCEmail = 'support@elixiatech.com,mrudang.vora@elixiatech.com,sanketsheth@elixiatech.com';
$emailmessage = "Daily Compliance Report - " . date('d-M-Y', strtotime($prevdate));
