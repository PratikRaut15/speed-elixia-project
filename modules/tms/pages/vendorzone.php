...
<style>
  #vendorzoneeff_filter{display: none}
  .dataTables_length{display: none}
</style>
<br/>
<div class='container' >
  <center>
    <h3>Vendor & Zone Wise Placement Efficiency </h3>
    ...
    <table class='display table table-bordered table-striped table-condensed' id="vendorzoneeff" style="width: 80%;" >
      <thead>
        <tr>
          <td><input type="text" class='search_init' name='transporters' style="width:90%;" autocomplete="off"/></td>
          <td><input type="text" class='search_init' name='zone' style="width:90%;" autocomplete="off"/></td>
...
<script type='text/javascript'>
 var data = <?php echo json_encode($transporterzoneEffArray); ?>;
 var tableId = 'vendorzoneeff';
 var tableCols = [
