<style>
  #editLrDetails table{width:80%;}
  #editLrDetails .frmlblTd{text-align:center}
...
<br/>
<div id='editLrDetails' class="modal hide">
    ...
    <form class="form-horizontal well" id="frmLrDetails" name="frmLrDetails" method="post" action="">
        ...
        <div class="col-xs-12" >
          <table style='width: 98%;' >
            ...
            <tr>
              ...
              <td>
                <input type="text" name="unloading" id="unloading" value="0" onkeyup="calculateDeliveryAmount();">
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <input type="text" name="unloading_charges" id="unloading_charges" value="0" onkeyup="calculateDeliveryAmount();">
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="auto_charges" id="auto_charges" value="0" onkeyup="calculateDeliveryAmount();">
              </td>
            </tr>
            <tr>
              <td>
      ...
      <div class='row'>
        <div class='col-xs-12' style='text-align:center; margin-top: 25px;' id="buttonpanel">
          <input type="button" class="btn btn-primary" value="Submit" id="editlrdata" onclick="saveLr();"/>
