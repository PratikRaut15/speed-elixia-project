      ...
      <table style="width:80%; border: none;" >
        ...
        <tr>
          <td colspan="4">ADD LR No.
            <a href="javascript:void(0);" id="addLrNo">&nbsp;<img src='../../images/show.png' title="ADD LR NO" alt="ADD LR NO"/></a>
          </td>
        </tr>
        <tr>
          <td colspan="4">
            <div id="lrDetails" style="width:80%; margin-left:2%;">
              ...
              if (isset($lrDetails) && !empty($lrDetails)) {
                ...
                foreach ($lrDetails as $lr) {
                  ...
                  $lrlist.='<div style="float: left;width: 10%;border: 1px solid #ccc;padding: 2px;" class="edit_id" id="edit_' . $lr['lrid'] . '"><img src="../../images/edit_black.png" class="editimage" onclick="editLrDetails(' . $lr['lrid'] . ');" /></div>';
                  $lrlist.='<div style="float: left;width: 10%;border: 1px solid #ccc;padding: 1px;" class="delete_id" id="delete_' . $lr['lrid'] . '"><img src="../../images/boxdelete.png" class="deleteimage" onclick="deleteLrDetails(' . $lr['lrid'] . ');"/></div>';
        ...
        <tr>
          <td colspan="4" style="text-align: center;">
            ...
            <input type="reset" class="btn btn-danger" id="cancel_bill_payable_draft" name="cancel_bill_payable_draft" value="Cancel"/>
          </td>
        </tr>
      </table>
    </form>
