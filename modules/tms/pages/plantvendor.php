...
<style>
  #plantvendoreff_filter{display: none}
  .dataTables_length{display: none}
</style>
<br/>
<div class='container' >
  <center>
    <h3>Plant Vendor Zone Wise Placement Efficiency</h3>
    ...
    <table class='display table table-bordered table-striped table-condensed' id="plantvendoreff" style="width: 80%;" >
      <thead>
        <tr>
...
<script type='text/javascript'>
 var data = <?php echo json_encode($zoneEffArray); ?>;
 var tableId = 'plantvendoreff';
 var tableCols = [
   {"mData": "factoryname"}
   , {"mData": "zonename"}
   , {"mData": "transportername"}
   , {"mData": "factoryidcount"}
   , {"mData": "placed"}
   , {"mData": "efficiency"}
 ];
</script>