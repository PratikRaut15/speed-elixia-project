...
<div class='container' >
    ...
    <form style='display:inline;width: 70%;' >
        ...
        <input type="text"  name="routename" id="routename" value="" maxlength="20"/>
        <span class="add-on" style="text-align: ">From</span>
        <select id="zoneid" name="fromlocationid" >
            <option value="0">Select Location</option>
        </select>
        <span class="add-on" style="text-align: ">To</span>
        <select id="zoneid" name="tolocationid" >
            <option value="0">Select Location</option>
        </select>
        <br/>
        <br/>
        <span class="add-on" style="text-align: left;">Distance(km)</span>
        <input type="text" style="width:105px;" name="routedistance" id="routedistance" value="" maxlength="11"/>
        <span class="add-on" style="text-align: left;">Time In Days</span>
        <input type="text"  style="width:105px;" name="routename" id="routename" value="" maxlength="11"/>
        <input style='display:inline;' type='button' class="btn  btn-primary" value='  Add Route  '/>
        </div>
     </form>
        </center>
