...
class api {
                ...
                if ($diffInDays <= 15) {
                    ...
                    if (isset($objRequest) && isset($objRequest->unitno)) {
                        ...
                        if (isset($data) && !empty($data)) {
                            ...
                            $complianceData[] = create_temp_from_reportcron_daily($data, $unit, $veh_temp_details, $objRequest->temp_sensors);
    ...
    public function getvehicledata($objGetLatestVehicleRequest) {
        ...
        while ($row = $this->db->fetch_array($records)) {
            ...
            switch ($status) {
                case 1:
                    $json_p[$x]['vehiclestatus'] = "Warehouse - Inactive";
                    break;
                case 2:
                    $json_p[$x]['vehiclestatus'] = "Warehouse - Idle-Ignition Off";
                    break;
                case 3:
                    $json_p[$x]['vehiclestatus'] = "Warehouse - Running";
                    break;
                case 4:
                    $json_p[$x]['vehiclestatus'] = "Warehouse - Overspeed";
                    break;
                case 5:
                    $json_p[$x]['vehiclestatus'] = "Warehouse - Idle-Ignition On";
                    break;
