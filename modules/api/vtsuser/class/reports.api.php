...
class reports {
    ...
    function getunitdetailsfromdeviceid($deviceid, $customerno) {
        ...
        $Query = "SELECT vehicle.fuel_min_volt, vehicle.fuel_max_volt, vehicle.fuelcapacity,vehicle.max_voltage,unit.unitno, unit.tempsen1, unit.tempsen2,unit.tempsen3,unit.tempsen4,unit.n1,unit.n2, unit.n3,unit.n4,unit.humidity,unit.acsensor, unit.fuelsensor, unit.is_ac_opp FROM unit
                ...
                foreach ($result as $row) {
                    ...
                    if ($graph && $last_ignition != $row['ignition']) {
                        if (isset($ig_lastupdated)) {
                            $graph_ignition[] = $this->set_humidity_graph_data($row['lastupdated'], null, null, null, null, null, "#$last_ignition#");
                        }
                        $graph_ignition[] = $this->set_humidity_graph_data($row['lastupdated'], null, null, null, null, null, "#{$row['ignition']}#");
            ...
            foreach ($arrRowData as $data) {
                ...
                case 4:
                    ...
                    if ($unitDetails['tempsen4'] != 0 && $data->$sensor != 0) {
                        $temperature4 = $this->gettemp($data->$sensor) . " &deg; C";
                ...
                case 3:
                    ...
                    if ($unitDetails['tempsen3'] != 0 && $data->$sensor != 0) {
                        $temperature3 = $this->gettemp($data->$sensor) . " &deg; C";
                ...
                case 2:
                    ...
                    if ($unitDetails['tempsen2'] != 0 && $data->$sensor != 0) {
                        $temperature2 = $this->gettemp($data->$sensor) . " &deg; C";
                ...
                case 1:
                    ...
                    if ($unitDetails['tempsen1'] != 0 && $data->$sensor != 0) {
                        $temperature1 = $this->gettemp($data->$sensor) . " &deg; C";
