...
$columns = array(
    ...
    array('db' => 'id', 'dt'=>11, 'formatter' => function($d, $row){
             ...
             * 
             */
            $view = " <a href='assign.php?id=14&oid=$d'><img src='../../images/icon_pages.png' width='16px;' height='16px;' alt='View'  title='View' /></a>";
...
$customWhere = " a.customerno=$customerno $groupQ $slotcondition ";
