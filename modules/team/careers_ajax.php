...
if (isset($_POST['send_bulk_email'])) {
    ...
    foreach($arrResult as $subscribers){
		...
		$arrToMailIds[] = $subscribers['email_id'];
 		...
 		if (!file_exists($attachmentFilePath.$attachmentFileName)) {
 			$attachmentFilePath = "";
 			$attachmentFileName = "";
 		}	
        ...
        $body .= '<a href = "http://www.elixiatech.com" title = "elixiatech.com" target  
         			="_blank">www.elixiatech.com</a><br/>';
        $body .= '<br/><img src = "http://elixiaspeed.com/images/logo.png" alt = "Elixia Tech Solutions Ltd."  style="width:30%;height:10%;"/><br/>';
        ...
        sendMailUtil($arrToMailIds, "", "", $subject, $body, $attachmentFilePath, $attachmentFileName,$isTemplatedMessage,$isElixiaTech);
    }
}
?>