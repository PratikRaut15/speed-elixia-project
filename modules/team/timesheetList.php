  ...
  $("#dateTS").on('change',function(){
    ...
    function refreshTimesheetGrid(){
          ...
          success: function(data){
            ...
            TSdetails = data.data; 
            duration = data.total;
            var submitTimesheet = $("#submit_task");
    ...
    function editCellRenderer(params){
      ...
      if(!params.node.group){
        //console.log(params);
        return "<a href='edit_timesheet.php?tsId="+params.data.tsId+"' alt='Edit' title='Edit' ><img style='text-align:center; width:20px; height:20px;' src='../../images/edit_icon_black.png'/></a>"
      }
    }
