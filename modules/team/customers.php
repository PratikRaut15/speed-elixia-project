...
if ($db->get_rowCount() > 0) {
    while ($row = $db->get_nextRow()) {
        ...
        {
            $customer->renewal_date='0000-00-00';
        }
        ...
        {
            $customer->sales_person='Not Assigned';
        }
...
$all_sales_person= Array();
$SQL4 = sprintf("SELECT name FROM team WHERE role='Sales'");
$db->executeQuery($SQL4);
if ($db->get_rowCount() > 0) {
    while ($row = $db->get_nextRow()) {
        $all_sales_person[]=$row['name'];
}
}

//print_r($all_sales_person); exit;
        ...
        <div class="panelcontents">
            <form method="post" name="myformcustomer" id="myformcustomer" action="createcustomer.php" onsubmit="return ValidateForm();
                ...
                <table width="50%" align="center">
                    ...
                    <tr>
                            <td>Sales Manager <span style="color:red;">*</span></td>
                            <td>
                            ...
                            ?>
                            <option value="<?php echo $sales->teamid; ?>"><?php echo $sales->name; ?></option>
                            <?php
                            }
                            }
                            ?>
