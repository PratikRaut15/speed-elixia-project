                ...
                <div id="tabs-1" class="tabstyle">
                    <table style="width:100%; border: none; text-align: left;" >
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="nametxt" id="nametxt" value="Suyog Patel"  autocomplete="off" required="" />
                            </td>
                            <td>
                                <span class="add-on">Code <span class="req">*</span></span>
                            </td>
                            <td>
                                <input type="text" name="code" id="code" value="CT001" autocomplete="off" required="" />
<!--                            <input type="hidden" name="vendorid" id="vendorid" value="" />-->
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="company" id="company" value="Suyog Logistics" autocomplete="off" required="" />
<!--                                <input type="hidden" name="depotid" id="locationid" value="" />-->
                            ...
                            <td>
                                <input type="text" name="branch" id="branch" value="Mumbai" autocomplete="off"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <textarea name="address" id="address" rows="2" cols="20">Suyog Logistics, NeelKanth Corporate Park, Viduvihar</textarea>
                            </td>
                            <td>
                                <span class="add-on">City</span>
                            </td>
                            <td>
                                <input type="text" name="city" value="Mumbai" id="city" placeholder="City">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" name="state" value="Maharashtra" id="state" value=""autocomplete="off"/>
                            </td>
                            <td><span class="add-on">Zip Code </span></td>
                            <td>
                                <input type="text" name="zipcode"  id="zipcode" value="400086"autocomplete="off"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" name="country"  id="country" value="India" autocomplete="off"/>
                            </td>
                            <td>
                                <span class="add-on">Mobile</span>
                            </td>
                            <td>
                                <input type="text" name="mobile" id="mobile" value="8888888888">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                               <input type="text" name="email_id" id="email_id" value="user@suyoglogistics.com" autocomplete="off"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <div id="tabs-2" class="tabstyle">
                    <table style="width:100%; border: none; text-align: left;">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cst" id="cst" value="275589546545464C"/>
                            </td>
                            <td>
                                <span class="add-on">Service Tax #</span>
                            </td>
                            <td>
                                <input type="text" name="servicetax" id="servicetax" value="AACCE546544D564547"/>
                            </td>
                        </tr>
                    </table>
                    <br/><br/>
                ...
                <div id="tabs-3" class="tabstyle">
                    <table style="width:100%; border: none; text-align: left;" >
                        <tr>
                            ...
                            <td>
                                <input type="text" name="creditdays" id="creditdays" value="30" />
                            </td>
                            <td>
                                <span class="add-on">Grace Days</span>
                            </td>
                            <td>
                                <input type="text" name="gracedays" id="gracedays" value="5" />
                            </td>
                        </tr>
                    </table>
                    <br/><br/>
                ...
                <div id="tabs-8" class="tabstyle">
                    ...
                    <table style="width:50%; border: 1px; text-align: left;">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="CST Certificate.pdf" target="_blank" style="color:blue;">Download</a>
                            </td>
                         ...
                         <tr>
                            ...
                            <td>
                                <a href="Vat tin certificate.pdf" target="_blank" style="color:blue;">Download</a>
                            </td>
