...
$vehicles = getDeletedVehicles($kind);
...
gridColumns = [
    {headerName:'Actions', field: 'realname', cellRenderer:'editCellRenderer', width:120},
    {headerName:'Vehicle No', field: 'vehicleno',width: 150},
    {headerName:'Group',field: 'groupname',width:200,filter: 'agTextColumnFilter'},
    {headerName:'Status',field: 'status_name',width:150,filter: 'agTextColumnFilter'},
    {headerName:'Last Modified By',field: 'modified_by',width:150,filter: 'agTextColumnFilter'},
    {headerName:'Last Modified At', field:'modified_on',width:200,filter: 'agTextColumnFilter'}
