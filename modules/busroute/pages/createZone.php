...
<div id="gc-topnav2"  class="ch_bar"  style="background-color:#ffffff;
    ...
    <div>
        <form name="createchk" id="createchk" action="route.php" method="POST">
            <div id="p1">
                <span id="fencename" style="display:none;">Please enter a Zone name.</span>
                <span id="incompletefence" style="display:none;">Please enter at least 3 points.</span>
                <span id="samename" style="display:none;">Zone name already exists.</span>  
                <div class="formline">

                    <div style="width:350px; height:auto; float:left; text-align:left;">
                        <a class="a" id="address"> Address </a>  <input type="text" name="fenceA" id="fenceA" style="width:82%" autocomplete="off" class="chkp_inp" placeholder="Enter a location">&nbsp;
                        <!--
                        ...
                        <div id="create_table" style="display:none">
                            <table border="0" style="background-color: white;"><tr>
                                ...
                                <tr>
                                    <td colspan="5" align="center"><input type="button" value="Create" onclick="savezone();"  id="createinp" class="..btn .btn-primary"></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
...
<div>
    ...
    <div id="gc-topnav2" style="background-color:#ffffff; display:none; " class="ch_bar">
        ...
        <input type="button" name="add marker" value="Save Fence" class="g-button g-button-submit"  id="signIn" onClick="savezone();" />
        <input type="button" name="close" id="edit"onclick="editform();" value="Edit" class="g-button g-button-submit" />
    </div>
    <div id="map" style="background-color: rgb(204, 204, 204);  position: relative;"></div>
</div>