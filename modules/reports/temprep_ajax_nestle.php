<?php
    if (isset($_POST['STdate']) && isset($_POST['EDdate'])) {
        ...
        $tripmin = $_POST['tripmin'];
        $tripmax = $_POST['tripmax'];
        ...
        //echo $tempselect; die;
        if(isset($tempselect)){
        	$tempselArr = explode("-", $tempselect); // this array will check it is temp1 or temp2 or All.    
        }
        ...
        if ($deviceid != 0) {
            if (isset($_SESSION['ecodeid'])) {
                ...
                if ($datecheck == 1) {
                    if ($datediffcheck <= 30) {
                        $return = gettemptabularreport_nestle($STdate, $EDdate, $deviceid, $interval, $stime, $etime, $tripmin, $tripmax);
                ...
                if ($datecheck == 1) {
                    if ($datediffcheck <= 30) {
                        $return = gettemptabularreport_nestle($STdate, $EDdate, $deviceid, $interval, $stime, $etime, $tripmin, $tripmax, $tempselect);
                        $final_graph_data_temp1 = "";
                        $final_graph_data_temp2 = "";
                        $final_graph_data_temp3 = "";
                        $final_graph_data_temp4 = "";
