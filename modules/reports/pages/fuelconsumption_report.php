...
function getFuelReport(){
    ...
    jQuery.ajax({
        url:"fuelconsumption_report_ajax.php",
        type: 'POST',
        data: data,
...
<form action="reports.php?id=29" method="POST"  id='FuelreportForm' onsubmit="getFuelReport();return false;">
<?php
$today = date('d-m-Y');
include 'panels/fuelconsumption_report.php';
?>
<?php
...
?>
    ...
    <tr>
        ...
        <td>
            <a href='javascript:void(0)' onclick="get_pdfFuel_Report(<?php  echo $_SESSION['customerno']; ?>,<?php echo $_SESSION['use_maintenance'];?>,<?php echo $_SESSION['use_hierarchy'];?>,<?php echo $_SESSION['groupid'];?>);"><img src="../../images/pdf_icon.png" alt="Export to PDF" class='exportIcons' title="Export to PDF" /></a>
            <a href='javascript:void(0)' onclick="html2xlsFuel_Report(<?php  echo $_SESSION['customerno']; ?>,<?php echo $_SESSION['use_maintenance'];?>,<?php echo $_SESSION['use_hierarchy'];?>,<?php echo $_SESSION['groupid'];?>); return false;"><img src="../../images/xls.gif" alt="Export to Excel" class='exportIcons' title="Export to Excel" /></a>
        </td>
    </tr>
