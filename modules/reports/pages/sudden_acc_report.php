...
<script>
    ...
    <?php } ?>
    function getSuddenAccReport(){
        jQuery('#centerDiv').html('');
        jQuery('#pageloaddiv').show();
        var data = jQuery("#suddenaccreportForm").serialize();
        jQuery.ajax({
            url:"sudden_acc_report_ajax.php",
            type: 'POST',
            data: data,
...
<form action="reports.php?id=14" method="POST" id="suddenaccreportForm" onsubmit="getSuddenAccReport();return false;">
<table>
    <thead>
        <tr><th id="formheader" colspan="100%">Sudden Acceleration Analysis</th></tr>
    </thead>
    <tbody>
    <tr>
        <td colspan="100%">
...
?>
    ...
    <tr>
        ...
        <td>
            <a href='javascript:void(0)' onclick="get_advanced_pdfreport('sudden_acc');"><img src="../../images/pdf_icon.png" alt="Export to PDF" class='exportIcons' title="Export to PDF" /></a>
            <a href='javascript:void(0)' onclick="get_advanced_xlsreport('sudden_acc');return false;"><img src="../../images/xls.gif" alt="Export to Excel" class='exportIcons' title="Export to Excel" /></a>
            <a href='javascript:void(0)' onclick="get_advanced_print('sudden_acc');"><img src="../../images/print.png" alt="Print Report" class='exportIcons' title="Print Report" /></a>
...
<div id='mail_pop' class='modal hide in' style='display:none;' >
    ...
    <div class='modal-body'>
        ...
        <div style='width:15%;border:4px;'><input type="submit"   onclick='send_advanced_mail(<?php  echo $_SESSION['customerno']; ?>, "sudden_accMail");return false;' class="g-button g-button-submit" value="Send" name="sendMail"></div>
        </form>
    </div> 
</div>
<?php /**/ ?>
