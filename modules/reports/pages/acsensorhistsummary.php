...
function getAcSensorHistReport(){
    ...
    jQuery.ajax({
        url:"acsensorhistsummary_ajax.php",
        type: 'POST',
        data: data,
...
<form action="reports.php?id=46" method="POST" id="AcSensorHistForm" onsubmit="getAcSensorHistReport();return false;">
<?php
...
$title = $_SESSION["digitalcon"].' Sensor Summary';
$today = date('d-m-Y');
...
?>
    ...
    <tr>
        ...
        <td>
            ...
            <a href='javascript:void(0)' onclick="get_pdfreportGenset2(<?php echo $_SESSION['customerno']; ?>,<?php  echo $_SESSION['switch_to']; ?>);"><img src="../../images/pdf_icon.png" alt="Export to PDF" class='exportIcons' title="Export to PDF" /></a>
            <a href='javascript:void(0)' onclick="html2xlsgenset2(<?php  echo $_SESSION['customerno']; ?>,<?php  echo $_SESSION['switch_to']; ?>);return false;"><img src="../../images/xls.gif" alt="Export to Excel" class='exportIcons' title="Export to Excel" /></a>
...
<?php
$mail_function = "send_gensetHist_mailsummary(".$_SESSION['customerno'].");";
