...
?>
    <tr>
        <td>Vehicle No.</td>
        <?php if($_SESSION["temp_sensors"] == $test){ echo "<td></td>"; } ?>
        <td>Start Date</td>
        <td>Start Hour</td>
        <td>End Date</td>
        <td>End Hour</td>
    ...
    <tr>
        ...
        <td>
            ...
            <a href='javascript:void(0)' onclick="get_pdfreportTempExcep(<?php  echo $_SESSION['customerno']; ?>);"><img src="../../images/pdf_icon.png" alt="Export to PDF" class='exportIcons' title="Export to PDF" /></a>
            <a href='javascript:void(0)' onclick="html2xlsTempExcep(<?php  echo $_SESSION['customerno']; ?>);return false;"><img src="../../images/xls.gif" alt="Export to Excel" class='exportIcons' title="Export to Excel" /></a>
...
<?php
$mail_function = "send_temp_mail(".$_SESSION['customerno'].");";
