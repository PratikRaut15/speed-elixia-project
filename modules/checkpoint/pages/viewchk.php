...
if (isset($checkpoints))
    foreach ($checkpoints as $checkpoint) {
        ...
        <tr>
            ...
            <td><?php
        if (isset($checkpoint->chktype)) {
            echo $checkpoint->chktype;
        } else {
            echo "N/A";
        }
        ?></td>
            ...
            <td><a href='checkpoint.php?id=3&chkid=<?php echo $checkpoint->checkpointid; ?>' ><i class='icon-pencil'></i></a></td>
            <td><a href = 'route.php?delid=<?php echo($checkpoint->checkpointid); ?>' onclick="return confirm('Are you sure you want to delete?');"><i class='icon-trash'></i></a></td>
        </tr>
    <?php
    } else
    echo "
