/*
    Name			-	assign_proposed_indent_to_next_transporter
    Description 	-	To assign the indent to next transporter once rejected
    Parameters		-	proposedindentidparam, proposed_transporterid, proposed_vehicletypeid,factid,depotidparam,custno,todaysdate
    Module			-	TMS
    Sub-Modules 	- 	Transporter Manual Indent Rejection
    Sample Call		-	CALL assign_proposed_indent_to_next_transporter(1, 1, 2, 1, 2, 116, '2015-12-08 00:00:00',1074);
    Created by		-	Mrudang
    Created on		- 	06 Feb, 2015
    Change details 	-	
    1) 	Updated by	- 	Mrudang
		Updated	on	- 	06 Feb, 2015
        Reason		-	Corrected the names and made it LIVE
    2)  Updated by	- 	Mrudang
		Updated	on	- 	06 Feb, 2015
        Reason		-	Everytime if any transporter reject it should ge to highest share transporter.
*/
DELIMITER $$
