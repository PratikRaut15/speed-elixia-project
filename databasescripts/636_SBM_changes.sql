...
VALUES (
'636', '2018-11-14 17:45:00', 'Manasvi Thakur','SBM changes  ', '0');
...
ALTER TABLE `setting`
ADD `use_vehicle_type` tinyint(2) NOT NULL DEFAULT '0' ;

INSERT INTO `setting` (`settingid`, `customerno`, `use_location_summary`, `use_vehicle_type`, `createdBy`, `createdOn`, `updatedBy`, `updatedOn`, `isdeleted`) VALUES (NULL, '447', '0', '1', '', '2018-11-14 00:00:00', '', '2018-11-14 00:00:00', '0');


UPDATE  dbpatches
SET     patchdate = '2018-11-14 17:45:00'
        ,isapplied =1
WHERE   patchid = 636;
