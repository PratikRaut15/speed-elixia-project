...
BEGIN
	...
	IF onoffParam = 1 and (custnoParam = 63 or custnoParam = 69 or custnoParam = 73 or custnoParam = 81 or custnoParam = 132  or custnoParam = 682) THEN
		BEGIN
		...
		END;
	ELSEIF onoffParam = 0 and (custnoParam = 63) THEN
		BEGIN
			INSERT INTO chk_offline(customerno,lastupdated,vehicleid,latitude,longitude)
			VALUES  (custnoParam,todaysdate,vehicleidParam, devicelatParam,devicelngParam);
        END;
