...
# Date pushed to UAT: 28-06-2019
# Description:
# Stored procedure written for Change in SP (get_vehiclewarehouse_details) , added new parameter as consigneeidParam and added condition to for consginee to display vehicles from tripdetails, this change is due to kutwal client - 795, 
# This report is used by Kutwal - 795
# 
#
***/
...
/* Updating dbpatche 717 */
    UPDATE `dbpatches` SET `isapplied` = '1' WHERE (`patchid` = '717');
