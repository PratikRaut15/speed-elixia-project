...
require_once("class/class.reports.php");
...
$reportsinfo = new reports();
$notify = new Notification();

$ajax->AjaxifyObjects(array("reportsinfo"));  
...
$page -> setExtJavaScripts14('js/forms_reports.js');
...
<?php 
					...
					$reportsinfo->SearchRecord($remarkname);
