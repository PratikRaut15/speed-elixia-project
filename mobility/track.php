...
$page -> setExtJavaScripts17('js/vehicles.js');
$page -> setExtJavaScripts18('js/prototype.js');
$page -> setExtJavaScripts19('js/markerwithlabel.js');
...
<div class="onecolumn">
	...
	<br class="clear"/>
	<div class="content">
		<div id="mapcontainer" style="float:left; width:950px; height:450px"></div>
		<br />
...
<?php $trackeeobj->selectcheckbox(); ?>


&nbsp;&nbsp

<div id="trackee_list"></div>                            
