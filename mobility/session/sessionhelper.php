...
function IsTracker()
{
    return (GetLoggedInUserAuth()=='Tracker');
}
...
function SetElixiaCode()
{
    $_SESSION["elixiacode"] = "Y";
}
function SetMessaging()
{
    $_SESSION["messaging"] = "Y";
}
function SetServiceCall()
{
    $_SESSION["service"] = "Y";
}
...
function GetItemDel()
{
    return $_SESSION["itemdel"];
}
function GetFencing()
{
    return $_SESSION["fencing"];    
}
function GetElixiaCode()
{
    return $_SESSION["elixiacode"];
}
function GetMessaging()
{
    return $_SESSION["messaging"];    
}
