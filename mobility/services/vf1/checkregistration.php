...
{    
    ...
    if(isset($registered))
    {
        ...
        $jsonstatus->usecreditcard = $registered->usecreditcard;        
        $jsonstatus->useforms = $registered->useforms;                
        $jsonstatus->usecheque = $registered->usecheque;                
        $jsonstatus->usepartialpayment = $registered->usepartialpayment;                        
        $jsonstatus->customercompany = $registered->customercompany;        
        ...
        $jsonstatus->pushform = $registered->pushform;                         
