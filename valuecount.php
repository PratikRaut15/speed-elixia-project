...
$type_value=0;
		...
		if($row['analog1_sen'] == 1 && $row['analog2_sen']==0 && $row['analog3_sen']==0 && $row['analog4_sen']==0){
		$type_value = $type_value + 8; 
		}

		if($row['analog1_sen'] == 0 && $row['analog2_sen']==1 && $row['analog3_sen']==0 && $row['analog4_sen']==0){
		$type_value = $type_value + 8 ;
		}

		if($row['analog1_sen'] == 0 && $row['analog2_sen']==0 && $row['analog3_sen']==1 && $row['analog4_sen']==0){
		$type_value = $type_value + 8 ;
		}

		if($row['analog1_sen'] == 0 && $row['analog2_sen']==0 && $row['analog3_sen']==0 && $row['analog4_sen']==1){
		$type_value = $type_value + 8 ;
		}
